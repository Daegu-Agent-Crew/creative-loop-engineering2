...
### 2026-07-14
- 결정: CLE2-13의 AI 협업 운영 프로토콜을 CLE3에 시범 적용한다.
- 이유: CLE2가 Unknown/승인 기준을 관리하고 CLE3가 실제 실행 기록을 관리해야 원칙과 결과가 연결된다.
- 근거 및 사용한 레퍼런스: CLE2 Issue #29, CLE3 패널 작업 큐와 Episode Workspace
- 확신도: high
- 남아 있는 불확실성: 실제 이미지 생성/QA 자동화가 연결된 뒤 기록 비용과 재작업 감소 효과
- 검토한 대안: CLE2-9 댓글에만 원칙 기록, CLE3에 독립 운영 문서만 추가
- 사람 승인: approved
- 영향: `DISCOVERY.md`와 CLE3 `discovery/decisions/approvals` 데이터를 추가한다.
