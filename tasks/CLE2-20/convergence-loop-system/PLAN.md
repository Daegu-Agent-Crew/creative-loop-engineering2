...
- **세부 작업**:
  - [x] preference-memory.json 스키마 (캐릭터별/장면별/스타일 앵커)
  - [x] 사람 선택 승인 패널 앵커 등록
  - [x] GPT Image 2 이미지 입력으로 레퍼런스 자동 주입 (D-008)
  - [x] "Example > Description" 원칙 적용
  - [x] CLE3 `수렴` UI와 PAT 기반 GitHub 반영 경로
- **예상 시간**: 1.5일
...
- **세부 작업**:
  ...
  - [x] 후보 2× 1회차 생성 및 AI 평가 (3패널, 총 6개)
  - [ ] 회장님 블라인드 선호 평가
  - [ ] 일치율 및 품질 개선 정도 측정
- **예상 시간**: 1일
